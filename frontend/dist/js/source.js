...
},{"../utils/storeShape":10,"../utils/warning":11,"_process":5,"react":"react"}],7:[function(require,module,exports){
(function (process){
'use strict';
...
},{"../utils/shallowEqual":9,"../utils/storeShape":10,"../utils/warning":11,"../utils/wrapActionCreators":12,"_process":5,"hoist-non-react-statics":1,"invariant":3,"lodash/isPlainObject":16,"react":"react"}],8:[function(require,module,exports){
'use strict';
...
},{"./components/Provider":6,"./components/connect":7}],9:[function(require,module,exports){
"use strict";
...
},{"redux":29}],13:[function(require,module,exports){
...
},{"./utilities":21,"_process":5,"immutable":2}],18:[function(require,module,exports){
'use strict';
...
},{"./combineReducers":17}],19:[function(require,module,exports){
'use strict';
...
},{"./getStateName":19,"immutable":2}],21:[function(require,module,exports){
'use strict';
'create index';
...
},{"./getStateName.js":19,"./getUnexpectedInvocationParameterMessage.js":20,"./validateNextState.js":22}],22:[function(require,module,exports){
'use strict';
...
},{"./createStore":28,"./utils/warning":30,"_process":5,"lodash/isPlainObject":34}],27:[function(require,module,exports){
"use strict";
...
},{"lodash/isPlainObject":34,"symbol-observable":35}],29:[function(require,module,exports){
(function (process){
'use strict';
...
},{"./applyMiddleware":24,"./bindActionCreators":25,"./combineReducers":26,"./compose":27,"./createStore":28,"./utils/warning":30,"_process":5}],30:[function(require,module,exports){
'use strict';
...
},{"./_getPrototype":31,"./_isHostObject":32,"./isObjectLike":33,"dup":16}],35:[function(require,module,exports){
(function (global){
/* global window */
'use strict';
...
},{"../util/api":65,"../util/constants":66}],39:[function(require,module,exports){
'use strict';
...
var _pagesFeed = require('pages/feed');

var _pagesFeed2 = _interopRequireDefault(_pagesFeed);
      ...
      return _react2['default'].createElement(
        ...
        _react2['default'].createElement(
          ...
          _react2['default'].createElement(
            ...
            _react2['default'].createElement(_reactRouter.Route, { path: '/feed', component: _pagesFeed2['default'] }),
...
},{"components/page":46,"pages/connect":53,"pages/explore":54,"pages/feed":55,"pages/home":56,"pages/messages":57,"pages/player":58,"pages/podcast":59,"pages/season":60,"react":"react","react-redux":8,"react-router":"react-router"}],48:[function(require,module,exports){
'use strict';
...
},{"./actions/podcast-actions":38,"./reducers/index":62,"components/router":47,"immutable":2,"lodash":4,"react":"react","react-dom":"react-dom","redux":29,"redux-immutable":18,"redux-thunk":23}],50:[function(require,module,exports){
/**
...
var Explore = (function (_React$Component2) {
  _inherits(Explore, _React$Component2);
...
},{"../actions/podcast-actions":38,"../util/state":67,"components/page":46,"lib/arrays":50,"lib/jsx-helpers":51,"lib/mock-data":52,"react":"react","react-redux":8,"react-router":"react-router"}],55:[function(require,module,exports){
'use strict';
...
var FeedItem = (function (_React$Component) {
  ...
  function FeedItem() {
    ...
    _get(Object.getPrototypeOf(FeedItem.prototype), 'constructor', this).call(this);
  }
    ...
    value: function render() {
      ...
      return _react2['default'].createElement(
        ...
        updates.map(function (update) {
          return _react2['default'].createElement(FeedItem, { item: update });
        })
      );
    }
  }]);
...
exports['default'] = (0, _reactRedux.connect)((0, _utilState.selectState)('updates'))(Feed);
module.exports = exports['default'];

},{"../util/state":67,"react":"react","react-redux":8,"react-router":"react-router"}],56:[function(require,module,exports){
'use strict';
...
},{"../actions/podcast-actions":38,"../util/state":67,"components/page":46,"react":"react","react-redux":8,"react-router":"react-router"}],58:[function(require,module,exports){
'use strict';
...
},{"lib/jsx-helpers":51,"lib/mock-data":52,"react":"react"}],61:[function(require,module,exports){
'use strict';
...
var EMPTY_LOGIN = _immutable2['default'].Map({ loggedIn: false, loggingIn: false, loginFailed: false, loginFailedMessage: null, loginError: null });
var LOGGING_IN = EMPTY_LOGIN.set('loggingIn', true);
var LOGIN_SUCCESS = EMPTY_LOGIN.set('loggedIn', true);

function loginState(state, action) {
  if (state === undefined) state = EMPTY_LOGIN;
  ...
  switch (action.type) {
    ...
    case _utilConstants.APP_ACTIONS.LOGIN:
      return LOGGING_IN;

    case _utilConstants.APP_ACTIONS.LOGIN_FAIL:
      return EMPTY_LOGIN.merge({ loginFailed: true, loginFailedMessage: action.message, loginError: action.error });

    case _utilConstants.APP_ACTIONS.LOGIN_SUCCESS:
...
},{"../util/constants":66,"immutable":2,"lodash":4}],62:[function(require,module,exports){
'use strict';
...
var _appReducers = require('./app-reducers');

var appReducers = _interopRequireWildcard(_appReducers);

var _podcastReducers = require('./podcast-reducers');

var podcastReducers = _interopRequireWildcard(_podcastReducers);

var _userReducers = require('./user-reducers');

var userReducers = _interopRequireWildcard(_userReducers);

exports['default'] = _lodash2['default'].assign({}, appReducers, podcastReducers, userReducers);
module.exports = exports['default'];

},{"./app-reducers":61,"./podcast-reducers":63,"./user-reducers":64,"lodash":4}],63:[function(require,module,exports){
'use strict';
...
},{"../util/constants":66,"immutable":2,"lodash":4}],64:[function(require,module,exports){
'use strict';
...
var EMPTY_USER = _immutable2['default'].Map({ id: 0, email: '' });

function user(state, action) {
  if (state === undefined) state = EMPTY_USER;

  switch (action.type) {

    case _utilConstants.USER_ACTIONS.LOAD_USER_SUCCESS:
...
},{"../util/constants":66,"immutable":2}],65:[function(require,module,exports){
'use strict';
...
},{"./constants":66,"whatwg-fetch":37}],66:[function(require,module,exports){
'use strict';
...
exports.APP_ACTIONS = APP_ACTIONS;
var PODCAST_ACTIONS = createActionsFor('LOAD_PODCAST', 'LOAD_PODCASTS');

exports.PODCAST_ACTIONS = PODCAST_ACTIONS;
var USER_ACTIONS = createActionsFor('LOAD_USER', 'UPDATE_USER', 'SHOW_SETTINGS');
...
},{"lodash":4}],67:[function(require,module,exports){
'use strict';
...
function selectState() {
  ...
  return function (state) {
    return _lodash2['default'].reduce(_arguments, function (obj, key) {
