...
import {EasingLogic, PageScrollConfig, PageScrollTarget, PageScrollingViews} from './page-scroll-config';
import {PageScrollUtilService} from './page-scroll-util.service';
...
export class PageScrollInstance {
    ...
    public static advancedInstance(document: Document,
        ...
        if (PageScrollUtilService.isUndefinedOrNull(scrollingViews) || scrollingViews.length === 0) {
            ...
            pageScrollInstance._scrollTopSources = [document.documentElement, document.getElementById('mainBody'), document.getElementById('mainBody').parentNode];
        } else {
