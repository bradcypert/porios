...
@Component({
  ...
  selector: 'td-file-upload-wide',
  styleUrls: [ './file-upload-wide.component.scss' ],
  templateUrl: './file-upload-wide.component.html',
})
export class TdFileUploadWideComponent {
